# taken from https://github.com/hplp/AES_implementations/blob/master/aes_PyRTL/romtest.py
...
rom1 = pyrtl.RomBlock(bitwidth=8, addrwidth=3, romdata=rom_data_array, name="rom1", max_read_ports=1, asynchronous=True)
